...
// 		expect(cleanedNumbers).toEqual([1, 2]); // <-- primitive value를 비교 할 때는 toBe가 아닌 toEqual로 검사 할 것
// 		expect(cleanedNumbers).not.toBe([1, 2]); // <-- primitive value를 비교 할 때는 toBe가 아닌 toEqual로 검사 할 것
// 	});
